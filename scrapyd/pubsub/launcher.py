...
from scrapyd.interfaces import IPoller, IEnvironment, IPubSub
...
class ScrapyProcessProtocol(protocol.ProcessProtocol):
    ...
    def connectionMade(self):
        ...
        reactor.callLater(int(self.timeout), killIfAlive)
